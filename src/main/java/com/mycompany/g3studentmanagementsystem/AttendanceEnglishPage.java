...
public class AttendanceEnglishPage extends JFrame implements ActionListener {
    ...
    public AttendanceEnglishPage() {
        ...
        // Get the logged-in faculty's subject
        String facultySubject = SessionManager.subject.toUpperCase();

        // MATH button — only visible to Math teachers
        ...
        // SCIENCE button — only visible to Science teachers
        ...
        // ENGLISH button — only visible to English teachers, disabled since currently in
