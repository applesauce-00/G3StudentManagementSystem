...
public class AttendanceMathPage extends JFrame implements ActionListener {
    ...
    public AttendanceMathPage() {
        ...
        // MATH button — visible only to Math teacher, disabled since currently in
        ...
        // SCIENCE button — visible only to Science teacher
        ...
        TableandDataLogic.loadData(tableModel, "Math", this);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnSave) {
            TableandDataLogic.saveData(tblStudent, tableModel, "Math", this);
