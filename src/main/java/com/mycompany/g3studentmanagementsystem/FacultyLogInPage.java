...
public class FacultyLogInPage extends JFrame implements ActionListener {
    ...
    FacultyLogInPage() {
        ...
        setTitle("UNIVERSITY FACULTY PORTAL");
        setSize(1024, 764);
        setLayout(null);
        ...
        lblTitle = new JLabel("UNIVERSITY FACULTY PORTAL");
        ...
        lblId = new JLabel("Faculty ID No.");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnBack) {
            ...
            switch (result) {
                ...
                case 0:
                    // Save the faculty's subject to SessionManager before navigating
                    SessionManager.subject     = FacultyDataManager.getFacultySubject(id);
                    SessionManager.facultyName = id;
