    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnCancel) {
            ...
            DefaultTableModel editorModel =
                    (DefaultTableModel) tblGrades.getModel();

            double math = Double.parseDouble(editorModel.getValueAt(0, 3).toString());
            double science = Double.parseDouble(editorModel.getValueAt(0, 4).toString());
            double english = Double.parseDouble(editorModel.getValueAt(0, 5).toString());
