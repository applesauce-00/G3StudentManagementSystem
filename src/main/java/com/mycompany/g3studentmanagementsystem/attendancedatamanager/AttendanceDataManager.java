        ...
        try (Connection conn = ConnectionString.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    rowData[2] = rs.getString("w1");
                    rowData[3] = rs.getString("w2");
                    rowData[4] = rs.getString("w3");
                    rowData[5] = rs.getString("w4");
                    rowData[6] = rs.getString("w5");
                    rowData[7] = rs.getString("w6");
                    rowData[8] = rs.getString("w7");
                    rowData[9] = rs.getString("w8");
                    rowData[10] = rs.getString("w9");
                    rowData[11] = rs.getString("w10");
    ...
    public static boolean saveAttendance(DefaultTableModel tableModel, String subjectName) {
        ...
        try (Connection conn = ConnectionString.getConnection();
            ...
            for (int r = 0; r < totalRows; r++) {
                String studentId = tableModel.getValueAt(r, 0).toString();
                String studentName = tableModel.getValueAt(r, 1).toString();
                
                String w1 = tableModel.getValueAt(r, 2).toString();
                String w2 = tableModel.getValueAt(r, 3).toString();
                String w3 = tableModel.getValueAt(r, 4).toString();
                String w4 = tableModel.getValueAt(r, 5).toString();
                String w5 = tableModel.getValueAt(r, 6).toString();
                String w6 = tableModel.getValueAt(r, 7).toString();
                String w7 = tableModel.getValueAt(r, 8).toString();
                String w8 = tableModel.getValueAt(r, 9).toString();
                String w9 = tableModel.getValueAt(r, 10).toString();
                String w10 = tableModel.getValueAt(r, 11).toString();
